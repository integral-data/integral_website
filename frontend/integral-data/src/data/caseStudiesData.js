...
export const caseStudiesData = [
  ...
  },
  {
    ...
    subheader:
      "Transitioning from Excel to a Web-Based Solution for Superior Functionality",
    author: "Jeff Barton",
  ...
  },
  {
    ...
    subheader:
      "Combining Python, Flask, HTML, and Selenium for an Interactive Experience",
    author: "Jeff Barton",
  ...
  },
  {
    ...
    chips: [<ChipPython />, <ChipPandas />, <ChipGithub />],
  ...
  },
  {
    id: 17,
    title:
      "Revolutionizing Talent Acquisition Reporting for a Fortune 500 Company",
    subheader: "From 2 Weeks to 4 Hours: The Power of Automation",
    author: "Jeff Barton",
    datePosted: "2023-07-15",
    badges: [<BadgePython />, <BadgeSQL />, <BadgeTableau />, <BadgeGithub />],
    chips: [<ChipPython />, <ChipSQL />, <ChipTableau />, <ChipGithub />],
