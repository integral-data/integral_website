...
export const caseStudiesData = [
    ...
    },
    {
        ...
        content: `## The Challenge\n\nWe were approached by **Select Choice**, who were in need of a CRM tool built from scratch. They required a custom back-end database architecture and a web-based front end that would enable their administrative team to efficiently manage all their clients.\n\n## Our Solution\n\nLeveraging the _Ruby-on-Rails_ framework, we developed a CRM tool tailored to the specific business needs of our client. The back-end database architecture was built using _PostgreSQL_. The front end was web-based, providing the administrative team with a user-friendly interface to track their clients.\n\n## Key Features\n\nThe tool kept track of numerous variables including, but not limited to:\n\n1. Programs offered by benefits providers\n2. Carriers (Aflac, Transamerica, etc.)\n3. Clients and their respective employees\n4. Agents selling the policies\n5. Attachments (PDFs, JPGs, etc.)\n6. Cases related to any issues with clients or their employees\n7. Policies and their basic details\n\n## The Outcome\n\nThe CRM tool streamlined operations for Select Choice. It served as a one-stop solution for managing their clients, policies, agents, and more. This project is another testament to our ability to develop custom software solutions that address specific business needs and yield tangible results.`,
    },

    {
        id: 9,
        title: "Master Spreadsheet Overhaul for Wealth Management",
        subheader: "Streamlining Client Information Tracking",
        author: "Jeff Barton",
        datePosted: "2023-07-10",
        content: `## The Issue\n\nA **wealth management company** was struggling to manage their client information with numerous, disjointed spreadsheets. This inefficient system was time-consuming and prone to errors.\n\n## Our Solution\n\nWe completely overhauled their existing spreadsheets and created a master spreadsheet with built-in data validation and automated calculations. This now serves as their main data entry point for important client information.\n\n## The Outcome\n\nThe introduction of the master spreadsheet greatly streamlined their operations. The client now enjoys an efficient, error-resistant system where they can enter and track the bulk of their important client information. This project once again demonstrated our ability to streamline business operations using practical and efficient solutions.`,
    },
    {
        id: 10,
...
},
{
    ...
    subheader: "Combining Python, Django, HTML, and Selenium for an Interactive Experience",
    author: "Jeff Barton",
